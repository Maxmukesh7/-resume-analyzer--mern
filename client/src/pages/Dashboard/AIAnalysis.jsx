  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <FaRobot className="text-[#F5B83D]" size={20} />
              <h1 className="text-2xl font-extrabold text-[#F5F5F5] tracking-wide">Google Gemini AI Resume Analysis</h1>
            </div>
          ...
          {loadingResumes ? (
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-[#0D0F12] border border-[#292D33] rounded-xl px-4 py-2 pr-9 text-xs font-semibold text-[#F5F5F5] focus:outline-none focus:border-[#F5B83D] cursor-pointer"
              >
                {resumes.map((r) => {
                  const id = r._id || r.id;
      ...
      {loadingAnalysis || analyzing ? (
        <Card className="p-12 space-y-6 text-center border-[#F5B83D]/20 bg-[#121519]">
          <div className="relative w-20 h-20 mx-auto flex items-center justify-center">
            <div className="absolute inset-0 bg-[#F5B83D]/10 rounded-full animate-ping" />
            <div className="p-4 bg-[#F5B83D]/20 border border-[#F5B83D]/30 text-[#F5B83D] rounded-full z-10">
              <FaRobot className="animate-bounce" size={32} />
            </div>
          </div>
          <div className="space-y-2">
            <h3 className="text-lg font-extrabold text-[#F5F5F5] tracking-wide">
          ...
          <div className="space-y-3 max-w-xl mx-auto pt-4">
            <div className="h-4 bg-[#171A1F] rounded-full animate-pulse w-3/4 mx-auto" />
            <div className="h-4 bg-[#171A1F] rounded-full animate-pulse w-full" />
            <div className="h-4 bg-[#171A1F] rounded-full animate-pulse w-5/6 mx-auto" />
          </div>
        </Card>
      ) : !analysis ? (
        <Card className="p-12 text-center space-y-4 bg-[#121519] border-[#292D33]">
          ...
          <h3 className="text-lg font-bold text-[#F5F5F5]">No Resume Selected</h3>
          <p className="text-xs text-[#A7ADB7] max-w-md mx-auto">
        ...
        <div ref={reportRef} className="space-y-8 p-1">
          {/* Summary & Rating Card */}
          <Card className="p-8 relative overflow-hidden border-[#F5B83D]/30 bg-[#121519]">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#292D33] pb-5 mb-5">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-[#F5B83D]/10 border border-[#F5B83D]/25 text-[#F5B83D] rounded-xl">
                  <FaMagic size={20} />
                </div>
                <div>
                  <h2 className="text-lg font-extrabold text-[#F5F5F5]">Executive Resume Summary</h2>
                  <p className="text-xs text-[#A7ADB7] font-semibold">AI Generated Executive Assessment</p>
                </div>
              </div>
          ...
          <Card className="p-6 space-y-4 bg-[#121519] border-[#292D33]">
            <h3 className="text-sm font-extrabold text-[#F5F5F5] uppercase tracking-wider flex items-center gap-2.5">
              <FaTasks className="text-[#F5B83D]" size={16} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {analysis.priorityActions && analysis.priorityActions.length > 0 ? (
                analysis.priorityActions.map((act, i) => (
                  <div key={i} className="p-3.5 bg-[#0D0F12] border border-[#292D33] rounded-xl flex items-start gap-3 text-xs text-[#F5F5F5] font-semibold">
                    <span className="p-1 bg-[#F5B83D]/20 border border-[#F5B83D]/40 text-[#F5B83D] rounded-md shrink-0">
                      {i + 1}
                    </span>
                    <span>{act}</span>
                  </div>
                ...
                <p className="text-xs text-[#A7ADB7]">No urgent priority actions listed.</p>
              )}
            </div>
          </Card>
            ...
            <Card className="p-6 border border-[#292D33] bg-[#121519] space-y-4">
              ...
              <ul className="space-y-3">
                {analysis.strengths && analysis.strengths.length > 0 ? (
                  ...
                  <p className="text-xs text-[#A7ADB7]">No strengths highlighted.</p>
                )}
              </ul>
            </Card>
            ...
            <Card className="p-6 border border-[#292D33] bg-[#121519] space-y-4">
              ...
              <ul className="space-y-3">
                {analysis.weaknesses && analysis.weaknesses.length > 0 ? (
                  ...
                  <p className="text-xs text-[#4ADE80] font-semibold">No major weak areas flagged!</p>
                )}
              </ul>
            </Card>
          </div>
          ...
          <Card className="p-6 space-y-4 bg-[#121519] border-[#292D33]">
            <h3 className="text-sm font-bold text-[#F5F5F5] uppercase tracking-wider flex items-center gap-2">
              <FaBrain className="text-[#FFD166]" size={16} />
            ...
            {analysis.missingSkills && analysis.missingSkills.length > 0 ? (
              ...
              <p className="text-xs text-[#4ADE80] font-semibold">No critical missing skills detected!</p>
            )}
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="p-6 space-y-4 bg-[#121519] border-[#292D33]">
              <h3 className="text-sm font-bold text-[#F5F5F5] uppercase tracking-wider flex items-center gap-2">
                <FaUserTie className="text-[#F5B83D]" size={16} />
              ...
              <ul className="space-y-3">
                {analysis.recruiterFeedback && analysis.recruiterFeedback.length > 0 ? (
                  ...
                  <p className="text-xs text-[#A7ADB7]">No recruiter notes available.</p>
                )}
              </ul>
            </Card>
            ...
            <Card className="p-6 space-y-4 bg-[#121519] border-[#292D33]">
              <h3 className="text-sm font-bold text-[#F5F5F5] uppercase tracking-wider flex items-center gap-2">
                <FaChartLine className="text-[#FFD166]" size={16} />
              ...
              <ul className="space-y-3">
                {analysis.careerSuggestions && analysis.careerSuggestions.length > 0 ? (
                  analysis.careerSuggestions.map((cs, i) => (
                    <li key={i} className="flex items-start gap-3 text-xs text-[#A7ADB7] font-medium">
                      <span className="w-1.5 h-1.5 bg-[#FFD166] rounded-full mt-1.5 shrink-0" />
                      <span>{cs}</span>
                    </li>
                  ))
                ) : (
                  <p className="text-xs text-[#A7ADB7]">No career suggestions listed.</p>
                )}
              </ul>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="p-6 space-y-3 bg-[#121519] border-[#292D33]">
              <div className="flex items-center gap-2">
                <FaEdit className="text-[#F5B83D]" size={14} />
              ...
              <ul className="space-y-2 text-xs text-[#A7ADB7]">
                {analysis.grammarSuggestions && analysis.grammarSuggestions.length > 0 ? (
                  ...
                  <p className="text-xs text-[#4ADE80] font-semibold">Writing style & grammar are clean!</p>
                )}
              </ul>
            </Card>
            ...
            <Card className="p-6 space-y-3 bg-[#121519] border-[#292D33]">
              <div className="flex items-center gap-2">
                <FaPalette className="text-[#FFD166]" size={14} />
                <h3 className="text-xs font-bold text-[#F5F5F5] uppercase tracking-wider">
              ...
              <ul className="space-y-2 text-xs text-[#A7ADB7]">
                {analysis.formattingSuggestions && analysis.formattingSuggestions.length > 0 ? (
                  ...
                  <p className="text-xs text-[#4ADE80] font-semibold">Layout formatting is optimal!</p>
                )}
              </ul>
            </Card>
          </div>
